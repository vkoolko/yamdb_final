# Generated by Django 2.2.16 on 2022-07-22 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[django.core.validators.RegexValidator(message='Недопустимый символ в слаге категории.', regex='^[-a-zA-Z0-9_]+$')], verbose_name='Слаг')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='Название')),
                ('year', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(2022, 'Проверьте год произведения.')], verbose_name='Год выпуска')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, 'Значения от 1 до 10'), django.core.validators.MaxValueValidator(10, 'Значения от 1 до 10')], verbose_name='Рейтинг')),
